  ...
  return <Design>
    <section className="flex flex-col items-center justify-center">
      ...
      >
        ...
        >
          <Input name="email" value={user.email} onChange={(e) => { handleChange(e.target.name, e.target.value) }} disabled='true' />
        </Form.Item>
        ...
        >
          <Select name='department' value={user.department} onChange={handleDepartment} disabled='true'>
        ...
        >
          <Input name="campus" value={user.campus} onChange={(e) => { handleChange(e.target.name, e.target.value) }} disabled='true' />
        </Form.Item>
